...
*   >   **Pregunta de Análisis:** Si en lugar de usar "LAN Segment (LAN1)", configuráramos estas máquinas en modo "Bridged" (Puente) conectándolas a la red física de la universidad, ¿qué impacto catastrófico tendría encender nuestro propio servidor DHCP en esa red de producción?
